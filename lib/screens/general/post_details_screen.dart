              ...
              children: [
                ...
                Row(children: [
                  ClipOval(
                    child: SizedBox(
                      width: 44, height: 44,
                      child: Image.asset(AppAssets.anna, fit: BoxFit.cover,
                ...
                ClipRRect(
                  ...
                  child: SizedBox(
                    ...
                    child: Image.asset(AppAssets.karnak, fit: BoxFit.cover,
                        errorBuilder: (_, __, ___) => Container(
                            height: 220,
                            color: AppColors.bgInput,
      ...
      child: Row(
        ...
        children: [
          ClipOval(
            child: SizedBox(
              width: 36, height: 36,
              child: Image.asset(c.avatar, fit: BoxFit.cover,
                  errorBuilder: (_, __, ___) => Container(
                      color: AppColors.bgInput,
                      child: const Icon(Icons.person,
                          color: Colors.white38, size: 18))),
